...
const CustomerDeliveries = lazy(() => import("./Postlogin/CustomerDeliveries"));
const ReturnedDeliveries = lazy(() => import("./Postlogin/ReturnedDeliveries"));
const Settings = lazy(() => import("./Postlogin/Settings"));
const WarehouseShipments = lazy(() => import("./Postlogin/WarehouseShipments"));
const StoreShipments = lazy(() => import("./Postlogin/StoreShipments"));
const Purchasers = lazy(() => import("./Postlogin/Purchasers"));
const DeliveryAgents = lazy(() => import("./Postlogin/DeliveryAgents"));
const Tickets = lazy(() => import("./Postlogin/Tickets"));
    ...
    <>
      <Suspense fallback={<div>Loading...</div>}>
        <Routes>
          ...
          <Route
            exact
            path={`${PREFIX_APP_PATH}/customer-deliveries`}
            element={<CustomerDeliveries />}
          />
          <Route
            exact
            path={`${PREFIX_APP_PATH}/delivery-agents`}
          ...
          <Route
            exact
            path={`${PREFIX_APP_PATH}/StoreShipments`}
